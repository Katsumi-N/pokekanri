  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        {cards.map((card) => (
          <div key={card.id} className="bg-white shadow-md rounded-lg p-4 flex flex-col">
            ...
            <div className="flex items-center space-x-2 mt-2">
              ...
              <Button onClick={() => saveCardQuantity(card, tempQuantities[card.id])} className="px-2 py-1 bg-green-500">
                <FaSave />
              </Button>
              <Button onClick={() => deleteCard(card.id)} className="px-2 py-1 bg-red-500">
                <FaTrash />
              </Button>
